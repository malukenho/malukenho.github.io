...
After the refactoring, we can easily solve the second part. We just need to change the
...
That is it! Second star unlocked! 🌟🌟
...
<div class="footnotes">
    <p>
        α) by getting the maximum value * `upper_bound` we cen say that this is the minimum
